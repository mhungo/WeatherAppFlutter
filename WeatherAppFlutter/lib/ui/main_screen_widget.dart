...
class MainScreenWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var model = context.watch<MainScreenModel>();
          ...
          builder: (context, AsyncSnapshot<ConnectivityResult> snapshot) {
            ...
            if (snapshot.hasData) {
              ...
              if (result == ConnectivityResult.mobile ||
                ...
                model = context.watch<MainScreenModel>();
                return Connected(model);
              }else {
                return noInternet();
              }
            } else {
              return requestCheckInternetAndRestart();
            }
          },
        ),
      ),
  ...
  Widget Connected(MainScreenModel model){
    return Scaffold(
      backgroundColor: Colors.white,
      body: model.forecastObject?.location?.name != null
          && model.loading == false
          ? _ViewWidget()
          : const Center(
  ...
  Widget requestCheckInternetAndRestart() {
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: const Text("Check your connection and restart."),
        ),
        ElevatedButton(
          style: ButtonStyle(
